...
function SidebarSubmenu({ route, linkClicked }: ISidebarSubmenu) {
  ...
  return (
    <li className="relative my-1" key={route.name}>
      {/* {isDropdownMenuOpen && (
        <span
          className='absolute inset-y-0 left-0 w-1 h-12 bg-cyan-400 rounded-tr-lg rounded-br-lg'
          aria-hidden='true'
        ></span>
      )} */}
      <button
      ...
      >
        <ul
          className="p-2 mt-2 mx-6 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900"
          aria-label="submenu"
        >
          {
